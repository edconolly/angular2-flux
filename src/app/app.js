...
var HeroesStore_1 = require('./HeroesStore');
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.updateHero = function (event, newName) {
        event.preventDefault();
        this.heroActions.updateHero(new HeroesStore_1.Hero(this.selectedHero.id, newName.value));
    };
    AppComponent = __decorate([
        ...
        __metadata('design:paramtypes', [HeroesStore_1.HeroesStore, HeroActions_1.HeroActions])
    ], AppComponent);
    return AppComponent;
})();
exports.AppComponent = AppComponent;
angular2_1.bootstrap(AppComponent, [http_1.HTTP_PROVIDERS, HeroesStore_1.HeroesStore, HeroActions_1.HeroActions, Dispatcher_1.Dispatcher]);
